...
**Статус:** готов pipeline данных и каркас UI — токены, сетка, загрузка,
служебные состояния, шапка. Блоки с данными не свёрстаны.
...
| [docs/ui-shell.md](docs/ui-shell.md) | Каркас UI: токены, сетка, слой загрузки, служебные состояния, состояние в URL |
...
│   ├── css/, js/          токены, каркас, модули загрузки и форматирования
│   ├── dev/               самопроверка контраста токенов
